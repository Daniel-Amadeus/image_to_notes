...
`;
        ...
        for (let r = 0; r < rowCount; r++) {
            ...
            lines += `<path fill="black" stroke="none" transform="translate(${this._padding + 0.5 * this._lineDistance} ${rowY - 2 * this._lineDistance}) scale(${rowHeight * 2})" d="${this._clefPath}"`;
